...
Since peer discovery is outside the scope of work for this test phase, peering within the client implementation presented within this repository is handled statically. For demonstrative purposes, the above illustration provides a high-level view into the peering algorithm defined in the following section. 
